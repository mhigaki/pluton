                    ...
                    <div id="single-project">
                        <?php if ( have_posts() ) : ?>
                            ...
                            <?php while ( have_posts() ) : the_post(); ?>
                                <div id="<?php echo 'slidingDiv'.$item_number ?>" class="toggleDiv row-fluid single-project<?php if( $item_number == 0) echo ' first'; ?> <?php echo join( ' ', get_post_class( '' ) ) ?>">
                                    <div class="span6">
                                    ...
                                    <div class="span6">
                                        <div class="project-description">
                                            ...
                                            <div class="project-info">
                                                <div>
                                                    <?php echo get_post_meta( get_the_ID(), 'poroject_info_client', true ); ?>
                                                </div>
                                                <div>
            ...
            <div class="section primary-section" id="about">
                ...
                <div class="container">
                    ...
                    <div class="row-fluid team">
                        ...
                        ?>
                        <?php $team = new WP_Query( $team_args ); ?>
                        <?php if ( $team->have_posts() ) : ?>
                            <?php $team_item_number = 0; ?>
                            <?php while ( $team->have_posts() ) : $team->the_post(); ?>
                                <div class="span4<?php if( $team_item_number == 0) echo ' first'; ?> <?php echo join( ' ', get_post_class( '' ) ) ?>" id="first-person-<?php the_ID(); ?>">
                                    <div class="thumbnail">
                                        <?php
                                            if ( has_post_thumbnail() ) {
